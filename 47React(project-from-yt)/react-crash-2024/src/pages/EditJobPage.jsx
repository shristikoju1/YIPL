            ...
            <div className="container max-w-2xl py-24 m-auto">
                <div className="px-6 py-8 m-4 mb-4 bg-white border rounded-md shadow-md md:m-0">
                    <form onSubmit={submitForm}>
                        ...
                        {/* Salary Field */}
                        <div className="mb-4">
                            <label htmlFor="salary" className="block mb-2 font-bold text-gray-700">Salary</label>
                            <select
                                id="salary"
                                name="salary"
                                className="w-full px-3 py-2 border rounded"
                        ...
                        <div className="mb-4">
                            <label htmlFor="company_description" className="block mb-2 font-bold text-gray-700">Company Description</label>
                            <textarea
                        ...
                        {/* Contact Email Field */}
                        <div className="mb-4">
                            <label htmlFor="contact_email" className="block mb-2 font-bold text-gray-700">Contact Email</label>
                            <input
                                type="email"
                                id="contact_email"
                                name="contact_email"
                        ...
                        {/* Contact Phone Field */}
                        <div className="mb-4">
                            <label htmlFor="contact_phone" className="block mb-2 font-bold text-gray-700">Contact Phone</label>
                            <input
                                type="tel"
                                id="contact_phone"
                                name="contact_phone"
